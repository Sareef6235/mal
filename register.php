...
#cursor-core { position: fixed; width: 10px; height: 10px; background: #67e8f9; border-radius: 50%; pointer-events: none; z-index: 9999; transform: translate(-50%, -50%); box-shadow: 0 0 18px rgba(103,232,249,.9), 0 0 28px rgba(34,211,238,.7); }
#cursor-ring { position: fixed; width: 34px; height: 34px; border: 1px solid rgba(103,232,249,.9); border-radius: 50%; pointer-events: none; z-index: 9999; transform: translate(-50%, -50%); box-shadow: 0 0 24px rgba(34,211,238,.45); }
.cursor-trail { position: fixed; width: 8px; height: 8px; background: rgba(34,211,238,.45); border-radius: 50%; pointer-events: none; z-index: 9998; transform: translate(-50%, -50%); box-shadow: 0 0 14px rgba(34,211,238,.55); transition: transform .18s linear, opacity .25s ease; }
...
:root { --bg:#07111f; --surface:rgba(10,22,40,.78); --card-border:rgba(255,255,255,.1); --text:#f5f7fb; --text-muted:#9fb1cc; }
body { font-family:'Inter','Noto Sans Malayalam',sans-serif; background: var(--bg); color: var(--text); }
.page-shell { max-width:1200px; margin:auto; padding:20px; }
.card,.glass { background: var(--surface); border:1px solid var(--card-border); border-radius:20px; padding:20px; backdrop-filter: blur(20px); }
.topbar { display:flex; justify-content:space-between; align-items:center; margin-bottom:20px; }
.brand { display:flex; gap:10px; align-items:center; }
.brand-mark { width:40px; height:40px; background:linear-gradient(135deg,#3b82f6,#9333ea); display:flex; align-items:center; justify-content:center; border-radius:10px; }
.menu a { margin-left:12px; text-decoration:none; color:var(--text-muted); padding:6px 10px; border-radius:8px; transition:.2s; }
.menu a:hover, .menu a.active { background:linear-gradient(135deg,#3b82f6,#9333ea); color:white; }
...
.field-label input { width:100%; padding:10px; border-radius:10px; border:none; background:rgba(255,255,255,.06); color:white; }
.primary-btn { background:linear-gradient(135deg,#3b82f6,#9333ea); border:none; padding:10px 16px; border-radius:10px; color:white; cursor:pointer; }
.muted { color: var(--text-muted); margin-top: 12px; }
.feature-list { margin-top: 12px; display:grid; gap:8px; color: var(--text-muted); }
    </style>
